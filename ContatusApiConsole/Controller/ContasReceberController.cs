...
{
    internal class ContasReceberController
    {
        public async Task<int> PostTotalItems()
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                var url = "https://services.contaazul.com/finance-pro-reader/v1/installment-view";
        ...
        public async Task<List<ContasReceber>> PostContasReceber(int pagina)
        {
            //int pagina = 1; // Substitua pelo valor desejado
            int tamanhoPagina = 1000; // Substitua pelo valor desejado
            DateTime dataInicial = DateTime.Parse("2021-01-01"); // Substitua pelo valor desejado
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (itemsToken != null)
                    {
                        ...
                        var contasReceber = itemsToken.ToObject<List<ContasReceber>>();
